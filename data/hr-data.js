...
const HR = [
  ...
  { n: "STAR · CAR · HERO", h: "Same facts. Three lengths. HR wants STAR. Manager wants CAR. Anyone short on time wants HERO (headline first).", c: [
    ...
    { n: "STAR: HR default",
      note: "<b>S for Situation</b> (1–2 sentences): company, team, stakes. Not a history of the org.<br><b>T for Task</b>: what <i>you</i> were on the hook for. One sentence.<br><b>A for Action</b> (60–70%): what <i>you</i> did, in order. Decisions, trade-offs, how you unblocked. Use “I”.<br><b>R for Result</b>: a number, then one lesson.<br>Optional <b>L (STAR-L)</b> on failure: “Next time I would …”: senior interviewers wait for this.",
      code:
...
R  $200K+ a year saved, same freshness. Next time I would
   ...
   not after finance pings.` },
    { n: "CAR: manager default",
      note: "<b>C for Challenge</b>: the hard thing in one line (constraint, risk, or broken state).<br><b>A for Action</b>: 3–5 verbs. What you decided, what you cut, what you measured.<br><b>R for Result</b>: number + whether it held.<br>No Task line: Challenge already implies what you owned. If the manager asks “what was your role?”, add one sentence and keep going. This is the format for “tell me about your most impactful project” and “how do you handle on-call.”",
      code:
...
R  $200K+/year off compute, SLAs held.` },
    { n: "HERO: headline first",
      note: "<b>H for Hook</b>: one sentence they can repeat in the debrief (“he cut $200K on Databricks”).<br><b>E for Example</b>: 3–4 sentences of what happened. This is your Action, compressed.<br><b>R for Result</b>: the same number, plus a second metric if you have one (failures, lag, tickets).<br><b>O for Ownership</b>: what was yours vs the team's, and what you'd do next. This is what a manager writes down as “owns outcomes.”<br>Use HERO when they say “give me the short version,” at the start of a panel, or when HR asks “what's your biggest achievement” and you can feel the clock.",
      code:
